...
# Locate the "Post to QuickBooks" button and click
post_to_qbo_button = driver.find_element(By.XPATH, "//span[normalize-space()='Post to QuickBooks']")
post_to_qbo_button.click()
